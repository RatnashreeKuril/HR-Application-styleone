...
DesignationDTO designation=designationDAO.getDesignationByCode(designationCode);
pw.println("Name : ");
...
String dateOfBirthString=simpleDateFormat.format(employee.getDateOfBirth());
pw.println("Date of birth : ");
pw.println("<b>"+dateOfBirthString+"</b><br>");
...
pw.println("<b>"+employee.getAadharCardNumber()+"</b><br><br>");
